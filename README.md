...
## Обзор ##
<div style="text-align: justify"> Разработан веб-сервис, который можно использовать для ускоренного обучения методу десятипальцевой слепой печати как корпоративных работников,
